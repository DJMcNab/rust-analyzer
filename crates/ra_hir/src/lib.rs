...
pub use crate::{
    ...
    code_model::{
        ...
        EnumVariant, FieldSource, FnData, Function, GenericParam, HasBody, Local, DeclarativeMacroDef, Module,
        ModuleDef, ModuleSource, Static, Struct, StructField, Trait, TypeAlias, Union,
    },
    expr::ExprScopes,
    from_source::FromSource,
    generics::GenericDef,
    ids::{DeclarativeMacroDefId, HirFileId, MacroCallId, MacroCallLoc, MacroFile},
    resolve::ScopeDef,
